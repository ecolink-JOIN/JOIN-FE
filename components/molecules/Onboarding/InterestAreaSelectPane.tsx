        ...
        {options.map((option) => (
          <Pressable
            ...
            style={{
              width: buttonSize,
              height: buttonSize,
              backgroundColor: studyPreferences.interestArea === option.id ? colors.primary : colors.sub2,
          ...
          >
            <Typography
              variant="button"
              style={{ color: studyPreferences.interestArea === option.id ? colors.white : colors.black }}
            >
              {option.value}
            </Typography>
          </Pressable>
